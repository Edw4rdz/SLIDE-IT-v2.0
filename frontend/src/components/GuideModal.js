...
const GuideModal = ({ isOpen, onClose }) => {
  ...
  const pages = [
    ...
    // Page 5: Tables
    {
      ...
      content: (
        <div>
          <div style={{ marginBottom: '24px', padding: '20px', backgroundColor: '#f9fafb', borderRadius: '12px', borderLeft: '4px solid #ec4899' }}>
            <h4 style={{ fontSize: '18px', fontWeight: '600', color: '#374151', marginBottom: '12px', display: 'flex', alignItems: 'center', gap: '8px' }}>
              <FaTable style={{ color: '#ec4899' }} /> Creating & Editing Tables
            </h4>
            
            <div style={{ display: 'grid', gap: '16px' }}>
              <div>
                <div style={{ fontWeight: '600', color: '#374151', marginBottom: '8px', fontSize: '15px' }}>➕ Add New Table</div>
                <p style={{ fontSize: '14px', color: '#6b7280', lineHeight: '1.6', margin: 0 }}>
                  Click "Add Table" button, specify the number of rows and columns, then click "Create Table" to insert it into your slide.
                </p>
              </div>
              
              <div>
                <div style={{ fontWeight: '600', color: '#374151', marginBottom: '8px', fontSize: '15px' }}>✏️ Edit Cell Content</div>
                <p style={{ fontSize: '14px', color: '#6b7280', lineHeight: '1.6', margin: 0 }}>
                  Click any cell to select it, then type to edit the content. Press Enter or click outside to save changes.
                </p>
              </div>
              
              <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
                <div style={{ flex: 1, minWidth: '200px', padding: '12px', background: '#fef2f2', borderRadius: '8px' }}>
                  <div style={{ fontWeight: '600', color: '#991b1b', marginBottom: '4px', fontSize: '14px' }}>Add/Delete Rows & Columns</div>
                  <div style={{ fontSize: '13px', color: '#7f1d1d' }}>Use toolbar buttons to modify table structure</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div style={{ marginBottom: '24px', padding: '20px', backgroundColor: '#f9fafb', borderRadius: '12px', borderLeft: '4px solid #8b5cf6' }}>
            ...
            <ul style={{ fontSize: '14px', color: '#6b7280', lineHeight: '1.8', margin: 0, paddingLeft: '20px' }}>
              <li><strong>Border Style:</strong> Choose solid or dashed borders</li>
              <li><strong>Border Width:</strong> Adjust thickness from 0.5pt to 2.25pt</li>
              <li><strong>Border Color:</strong> Pick any color for table borders</li>
              <li><strong>Background Color:</strong> Set the cell background color</li>
            </ul>
          </div>
          ...
          <div style={{ marginBottom: '24px', padding: '20px', backgroundColor: '#f0f9ff', borderRadius: '12px', border: '2px solid #3b82f6' }}>
            ...
            <ul style={{ fontSize: '14px', color: '#1e40af', lineHeight: '1.8', margin: 0, paddingLeft: '20px' }}>
              <li>Click the table frame to select it</li>
              <li>Drag to move the table anywhere on the slide</li>
              <li>Drag edges to resize the entire table</li>
            </ul>
          </div>

          <div style={{ padding: '16px', backgroundColor: '#fef3c7', borderRadius: '12px', border: '2px dashed #f59e0b' }}>
            <p style={{ fontSize: '14px', color: '#92400e', lineHeight: '1.6', margin: 0 }}>
              <strong>💡 Pro Tip:</strong> Use tables for data, comparisons, or structured content. They automatically export perfectly to PowerPoint!
            </p>
          </div>
        </div>
      ),
